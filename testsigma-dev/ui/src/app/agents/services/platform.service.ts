...
export class PlatformService {
  ...
  public findAll(workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<Platform[]> {
    return this.http.get<Platform[]>(environment.apiUrl+"/platforms?workspaceType=" + workspaceType + "&testPlanLabType=" + testPlanLabType, {
  ...
  public findAllOsVersions(platform: Platform, workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<PlatformOsVersion[]> {
    return this.http.get<PlatformOsVersion[]>(environment.apiUrl+"/platforms/"+platform.id+"/os_versions?workspaceType="+workspaceType+"&testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findOsVersion(platformOsVersionId: Number, testPlanLabType: TestPlanLabType):Observable<PlatformOsVersion>{
    return this.http.get<PlatformOsVersion>(environment.apiUrl+"/platforms/"+platformOsVersionId+"/os_version?testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findAllBrowsers(platform: Platform, osVersion: PlatformOsVersion, workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<PlatformBrowser[]> {
    return this.http.get<PlatformBrowser[]>(environment.apiUrl+"/platforms/"+platform.id+"/"+osVersion?.version+"/browsers?workspaceType="+workspaceType+"&testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findAllScreenResolutions(platform: Platform, osVersion: PlatformOsVersion, workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<PlatformScreenResolution[]> {
    return this.http.get<PlatformScreenResolution[]>(environment.apiUrl+"/platforms/"+platform.id+"/"+osVersion?.version+"/screen_resolutions?workspaceType="+workspaceType+"&testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findScreenResolution(platformScreenResolutionId: Number, testPlanLabType: TestPlanLabType):Observable<PlatformScreenResolution>{
    return this.http.get<PlatformScreenResolution>(environment.apiUrl+"/platforms/"+platformScreenResolutionId+"/screen_resolution?testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findAllBrowserVersions(platform: Platform, osVersion: PlatformOsVersion, browser: PlatformBrowser, workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<PlatformBrowserVersion[]> {
    return this.http.get<PlatformBrowserVersion[]>(environment.apiUrl+"/platforms/"+platform.id+"/"+osVersion?.version+"/browser/"+browser?.name+"/versions?workspaceType="+workspaceType+"&testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  public findBrowserVersion(platformBrowserVersionId: Number, testPlanLabType: TestPlanLabType):Observable<PlatformBrowserVersion>{
    return this.http.get<PlatformBrowserVersion>(environment.apiUrl+"/platforms/"+platformBrowserVersionId+"/browser_version?testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
  ...
  findAllDevices(platform: Platform, platformOsVersion: PlatformOsVersion, workspaceType: WorkspaceType, testPlanLabType: TestPlanLabType): Observable<CloudDevice[]> {
    return this.http.get<CloudDevice[]>(environment.apiUrl+"/platforms/"+platform.id+"/"+platformOsVersion.version+"/devices?workspaceType="+workspaceType+"&testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(
      map((data) => {
  ...
  public findDevice(platformDeviceId: Number, testPlanLabType: TestPlanLabType):Observable<CloudDevice>{
    return this.http.get<CloudDevice>(environment.apiUrl+"/platforms/"+platformDeviceId+"/device?testPlanLabType="+testPlanLabType, {
      headers: this.httpHeaders.contentTypeApplication
    }).pipe(map((data) => {
